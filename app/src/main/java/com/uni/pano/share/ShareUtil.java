...
public class ShareUtil {
    ...
    public static void openSharingPanel(final Activity activity, final MediaInfo mediaInfo, boolean isFullScreen,
     ...
     * @return
     */
    private static boolean isSharingPlatformAvailable(Context context, SHARE_MEDIA media) {
